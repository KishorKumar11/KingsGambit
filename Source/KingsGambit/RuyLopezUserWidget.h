...
protected:
	...
	UFUNCTION()
		void StepEVWP1ToBackClicked();

	UFUNCTION()
		void StepEVWP2Clicked();

	UFUNCTION()
		void StepEVWP2ToBackClicked();

	UFUNCTION()
		void StepEVWP3Clicked();

	UFUNCTION()
		void StepEVWP3ToBackClicked();

	UFUNCTION()
		void StepEVBP1Clicked();

	UFUNCTION()
		void StepEVBP1ToBackClicked();

	UFUNCTION()
		void StepEVBP2Clicked();

	UFUNCTION()
		void StepEVBP2ToBackClicked();

	UFUNCTION()
		void StepEVBP3Clicked();

	UFUNCTION()
		void StepEVBP3ToBackClicked();
	...
	UFUNCTION()
		void StepADWP1ToBackClicked();

	UFUNCTION()
		void StepADWP2Clicked();

	UFUNCTION()
		void StepADWP2ToBackClicked();

	UFUNCTION()
		void StepADWP3Clicked();

	UFUNCTION()
		void StepADWP3ToBackClicked();

	UFUNCTION()
		void StepADBP1Clicked();

	UFUNCTION()
		void StepADBP1ToBackClicked();

	UFUNCTION()
		void StepADBP2Clicked();

	UFUNCTION()
		void StepADBP2ToBackClicked();
	...
	UFUNCTION()
		void StepCDWP1ToBackClicked();

	UFUNCTION()
		void StepCDWP2Clicked();

	UFUNCTION()
		void StepCDWP2ToBackClicked();

	UFUNCTION()
		void StepCDBP1Clicked();

	UFUNCTION()
		void StepCDBP1ToBackClicked();

	UFUNCTION()
		void StepCDBP2Clicked();

	UFUNCTION()
		void StepCDBP2ToBackClicked();

	UFUNCTION()
		void StepCDBP3Clicked();

	UFUNCTION()
		void StepCDBP3ToBackClicked();
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepEVWP1ToBack;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepEVWP2;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepEVWP2ToBack;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepEVWP3;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepEVWP3ToBack;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepEVBP1;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepEVBP1ToBack;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepEVBP2;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepEVBP2ToBack;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepEVBP3;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepEVBP3ToBack;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepADBP1ToBack;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepADBP2;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepADBP2ToBack;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepADBP3;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepADBP3ToBack;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepADWP1;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepADWP1ToBack;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepADWP2;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepADWP2ToBack;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepCDBP1ToBack;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepCDBP2;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepCDBP2ToBack;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepCDBP3;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepCDBP3ToBack;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepCDWP1;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepCDWP1ToBack;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepCDWP2;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
		UButton* StepCDWP2ToBack;
